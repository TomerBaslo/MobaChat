...
import com.example.tomer.baslo.firebasechat.FirebaseApp;
import com.example.tomer.baslo.firebasechat.R;
import com.example.tomer.baslo.firebasechat.Chat;
...
public class ChatActivity extends AppCompatActivity {
    ...
    // start activity and pass the firebase token, username and password
    ...
    // initlize views using their ids
    private void bindViews() {
        mToolbar = (Toolbar) findViewById(R.id.toolbar);
    }
    //initialize the toolbar, and load the fragment to the activity frame layout
    private void init() {
        // set the toolbar
    ...
    protected void onResume() {
        super.onResume();
        FirebaseApp.setChatActivityOpen(true);
    }

    @Override
    protected void onPause() {
        super.onPause();
        FirebaseApp.setChatActivityOpen(false);
    }
